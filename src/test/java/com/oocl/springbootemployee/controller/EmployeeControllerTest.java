...
class EmployeeControllerTest {
    ...
    private void giveDataToRepository() {
    ...
    void should_remove_employee_success() throws Exception {
        ...
        assertThat(employees.get(0).getId()).isNotNull();
        assertThat(employees.get(1).getId()).isNotNull();
        assertThat(employees.get(2).getId()).isNotNull();
        assertThat(employees.get(3).getId()).isNotNull();
    }
